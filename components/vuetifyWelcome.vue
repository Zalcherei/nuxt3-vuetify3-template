  ...
  <v-app>
    <v-main class="d-flex justify-center align-center h-screen">
      <v-container fluid>
        ...
        <v-card title="Get Started" append-icon="mdi-fire">
          <v-card-text>
            Remove this welcome page by replacing &lt;vuetifyWelcome /&gt; in
            app.vue with your own code.
          </v-card-text>
        </v-card>
        ...
        <v-row class="mt-2">
          <v-col>
            <v-card
              title="Documentation"
              append-icon="mdi-book-open-outline"
              :text="readDocs"
            >
            </v-card>
          </v-col>
          ...
          <v-col>
            <v-card title="GitHub" append-icon="mdi-github" :text="starGitHub">
            </v-card>
          </v-col>
